...
def prop_noise(CP, n, D, Vinf, r, B=6, N=2, rho = 1.25, a = 340):
...
if __name__ == "__main__":
    Jmax = 1.6
    D = 0.2023 * 20
    # r_mic = np.array([46, 44, 43]) / 100
    # r = np.linalg.norm(r_mic)

    r = 100
    # for V, NFzero in zip([20, 40, 140], [LTT_noise_floor_20, LTT_noise_floor_40, 0]):
    for V, NFzero in zip([140], [0]):
        n = V / Jmax / D
